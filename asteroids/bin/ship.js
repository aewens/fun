...
(function() {
  ...
  Ship = (function(_super) {
    ...
    Ship.prototype.shoot = function() {
      var bullet;
      bullet = new Bullet(this.points[0] + this.x, this.points[1] + this.y, this.angle);
      bullet.max.x = this.max.x;
      bullet.max.y = this.max.y;
      return bullet;
    };
